...
const Sidebar: React.FC<SidebarProps> = ({ role }) => {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-[#0B0B0B] border-r border-zinc-800 transition-all duration-300">
      ...
      <div className="p-4 mt-auto border-t border-zinc-800">
        <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-zinc-900 transition-colors cursor-pointer text-zinc-400">
          <Settings size={18} />
