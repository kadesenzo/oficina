    ...
    `}>
      <div className="p-10 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-[#E11D48] rounded-xl flex items-center justify-center glow-red shadow-lg shadow-red-900/20">
        ...
        <button 
          onClick={onClose}
          className="md:hidden p-2 text-zinc-600 hover:text-white transition-colors"
        >
          <X size={20} />
        </button>
      </div>

      <nav className="flex-1 mt-2 px-6 space-y-1 overflow-y-auto no-scrollbar pb-10">
